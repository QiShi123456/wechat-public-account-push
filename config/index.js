...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wxef5cdb5a65348e3e',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'e4643174ef6baea73b616f4ec7d3924d',
  ...
  USERS: [
    {
      ...
      id: 'ov5IX6H37rskDQE2VssH_3akKqFY',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'NcoS4LEOk1tJdeX-u6Q8DXwyx8x15zvV7ajYiHIbIaY',
      // 所在省份
      province: '河北',
      // 所在城市
      city: '廊坊',
      ...
      openUrl: 'https://birdy02.com',
      // 专属节日提醒，如果你在这里填写了节日提醒，就不会执行FESTIVALS的提醒了, 和FESTIVALS的配置方法相同，可以往下查看，我这里就不重复写了
      festivals: [
        // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
        {
          type: '*生日', name: '老婆', year: '2002', date: '11-28',
        }
      ],
      ...
      name: '老婆',
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: 'ov5IX6Gm6-HYzp6AlgMbnYf9TnKE',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'NcoS4LEOk1tJdeX-u6Q8DXwyx8x15zvV7ajYiHIbIaY',
      // 所在省份
      province: '河北',
